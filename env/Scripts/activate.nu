...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Zain Ali\Documents\Python_Tutorials\FlaskBookLibrary\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Zain Ali\Documents\Python_Tutorials\FlaskBookLibrary\env\Scripts\deactivate.nu'
